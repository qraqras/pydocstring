...
def walk(
    ...
    Because CST structure and style are orthogonal, a single visitor instance can
    handle mixed-style code bases:

    .. code-block:: python

        class MyChecker:
            def visit_google_arg(self, arg: GoogleArg) -> None: ...
            def visit_numpy_parameter(self, param: NumPyParameter) -> None: ...

        for source_text in all_docstrings:
            doc = pydocstring.parse(source_text)   # auto-detects style
    ...
    .. code-block:: python
        ...
        def visit_google_docstring(self, doc: GoogleDocstring) -> None: ...
        def visit_google_section(self, section: GoogleSection) -> None: ...
        def visit_google_arg(self, arg: GoogleArg) -> None: ...
        def visit_google_return(self, ret: GoogleReturn) -> None: ...
        def visit_google_yield(self, yld: GoogleYield) -> None: ...
        def visit_google_exception(self, exc: GoogleException) -> None: ...
        def visit_google_warning(self, wrn: GoogleWarning) -> None: ...
        def visit_google_see_also_item(self, sai: GoogleSeeAlsoItem) -> None: ...
        def visit_google_attribute(self, att: GoogleAttribute) -> None: ...
        def visit_google_method(self, mtd: GoogleMethod) -> None: ...

    NumPy-style ``visit_*`` methods:

    .. code-block:: python

        def visit_numpy_docstring(self, doc: NumPyDocstring) -> None: ...
        def visit_numpy_section(self, section: NumPySection) -> None: ...
        def visit_numpy_deprecation(self, dep: NumPyDeprecation) -> None: ...
        def visit_numpy_parameter(self, param: NumPyParameter) -> None: ...
        def visit_numpy_returns(self, ret: NumPyReturns) -> None: ...
        def visit_numpy_yields(self, yld: NumPyYields) -> None: ...
        def visit_numpy_exception(self, exc: NumPyException) -> None: ...
        def visit_numpy_warning(self, wrn: NumPyWarning) -> None: ...
        def visit_numpy_see_also_item(self, sai: NumPySeeAlsoItem) -> None: ...
        def visit_numpy_reference(self, ref: NumPyReference) -> None: ...
        def visit_numpy_attribute(self, att: NumPyAttribute) -> None: ...
        def visit_numpy_method(self, mtd: NumPyMethod) -> None: ...
    """
    ...
